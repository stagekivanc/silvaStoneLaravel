...
@section('title', 'Yeni Ürün Kategorisi Ekle')
@section('page_title', 'Yeni Ürün Kategorisi Ekle')
...
<div class="max-w-7xl mx-auto">
    ...
    <form action="{{ route('yonetim.urun-kategorileri.store') }}" method="POST" enctype="multipart/form-data" id="categoryCreateForm" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        @csrf
                ...
                <div data-lang-area="{{ $lang->code }}" class="{{ $lang->is_default ? '' : 'hidden' }} space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="translations[{{ $lang->code }}][name]" @if($lang->is_default) required @endif
                                   ...
                                   placeholder="Örn: Tabanlık ve Konfor Sistemleri">
                        </div>
                        <div class="space-y-2">
                            <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="translations[{{ $lang->code }}][home_description]" rows="2" 
                                  ...
                                  placeholder="Anasayfa kartında görünecek kısa açıklama"></textarea>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between pt-2">
                        ...
                        <select name="home_status" class="bg-slate-50 border border-slate-200 text-slate-900 py-2 px-4 rounded-xl text-sm font-bold">
                            <option value="1" selected>Görünsün</option>
