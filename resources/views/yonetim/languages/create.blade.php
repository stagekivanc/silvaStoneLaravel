...
@section('page_title', 'Yeni Dil Ekle')
...
<div class="max-w-7xl mx-auto">
    ...
    <form action="{{ route('yonetim.languages.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" required
                               ...
                               value="{{ old('name') }}" placeholder="Örn: İngilizce">
                    </div>
                    <div class="space-y-2">
                        <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-2">
                        ...
                        <input type="text" name="code" required
                               ...
                               value="{{ old('code') }}" placeholder="Örn: en">
                    </div>
                </div>
            </div>
        </div>
